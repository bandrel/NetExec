...
from nxc.helpers.ntsecuritydescriptor import WELL_KNOWN_SIDS
...
# Universal SIDs: WELL_KNOWN_SIDS is the single source of truth in
# nxc.helpers.ntsecuritydescriptor (imported above).
